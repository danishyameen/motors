...
export default function Header(){
    return(
        <main className="mt-5 mb-5 sticky top-0 bg-white shadow-xl">
            <header className="mt-5 grid sm:grid-cols-2 gap-2">
                <div className="logo mb-2 mt-3">
                    <Image src={Logo} alt="logo" className="w-[250px] m-auto"/>
                </div>
                    <ul className="flex justify-center gap-9 mt-3 text-[20px]">
